...
### Розгортання: обмін ROM на швидкість
...
Ціна — розмір коду: 256 повторень займають 512 байтів проти 7 у циклі. Ти обмінюєш ROM на швидкість.
...
Ланцюжок окремих інструкцій LDI --- це просто 256 повторень двобайтового опкоду `$ED $A0`. Це 512 байтів коду для економії 24% --- той самий компроміс ROM-за-швидкість, що й розгортання циклів.
