...
У 2024 році Gogin (з російської ZX-сцени) зібрав колекцію Z80 ГПВЧ-підпрограм і поділився ними для оцінки. Артем Топчій протестував їх систематично, заповнюючи великі растрові зображення для виявлення статистичних патернів. Результати повчальні -- не всі "випадкові" підпрограми однаково випадкові.
...
Вердикт Артема Топчія: **найкраща якість** у колекції. При заповненні растрового зображення 256x192 видимих патернів не виникає навіть у великих масштабах.
...
Вердикт Артема Топчія: **друге місце**. Дуже компактний, хороша якість для свого розміру.
...
Варіант CMWC від Raxoft, подібний за принципом до версії Патріка Рака, але з іншим розташуванням буфера. Артем Топчій виявив, що він дає **видимі патерни у великому масштабі** -- ймовірно, через те, як поширення перенесення взаємодіє з індексацією буфера. Ми включаємо його в компільований приклад (`examples/prng.a80`) для повноти, але для продакшн-використання версія Патріка Рака однозначно краща.
...
> **Подяки:** Колекцію ГПВЧ зібрав **Gogin**. Оцінку якості та растрове тестування провів **Артем Топчій**. CMWC-генератор Патріка Рака базується на теорії Complementary Multiply-With-Carry Джорджа Марсальї. Ion Random походить з **Ion Shell** для калькулятора TI-83.
