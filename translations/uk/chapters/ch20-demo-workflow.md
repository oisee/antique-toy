...
ZX Spectrum демосцена має напрочуд сильну культуру документування того, як робляться демо. Це не універсально в ширшій демосцені — на багатьох платформах демо випускаються без документації, крім кредитів. На Spectrum-сцені детальні making-of статті — традиція, і Hype (hype.retroscene.org) — основний майданчик для їх публікації.
...
**Chaos Constructions (CC)** — найбільший та найпрестижніший ZX демо-івент, що проводиться в Санкт-Петербурзі, Росія. ZX демо-компо на CC збирає найсильніші роботи: Break Space (2016), наступники Eager та продукції груп Thesuper, 4th Dimension і Placeholders. CC — це місце, де ти змагаєшся на найвищому рівні. Аудиторія велика, обізнана і невблаганна.
...
Ти не переможеш. Твої ефекти будуть простішими, ніж у досвідчених груп. Твоя синхронізація буде недосконалою. Твої переходи будуть грубими. Ніщо з цього не має значення. Важливо те, що ти завершив демо, подав його на компо і приєднався до спільноти, що робить це вже тридцять років. Наступне демо буде кращим. І те, що після нього.
