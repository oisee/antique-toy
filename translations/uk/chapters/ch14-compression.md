...
Менше 30 байт коду розпаковувача. RLE стискає чудово, коли дані містять довгі серії --- порожні екрани, однокольорові фони, заповнення атрибутами. Воно стискає жахливо на складному піксельному мистецтві. Перевага над LZ: для sizecoding-інтро, де навіть 70 байт ZX0 здаються дорогими, власна RLE-схема звільняє цінний простір.
...
> **Джерела:** Introspec "Data Compression for Modern Z80 Coding" (Hype, 2017); Introspec "Compression on the Spectrum: MegaLZ" (Hype, 2019); Break Space NFO (Thesuper, 2016); Einar Saukas, ZX0 (github.com/einar-saukas/ZX0)
