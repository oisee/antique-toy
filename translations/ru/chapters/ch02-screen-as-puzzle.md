...
**Частный случай: когда биты развёрточной строки в H равны 111.** Если ты проходишь знакоместо сверху вниз и только что обработал последнюю развёрточную строку (строка 7), младшие 3 бита H — `111`. В этом случае есть более быстрая 4-инструкционная конверсия, предложенная Art-top:
