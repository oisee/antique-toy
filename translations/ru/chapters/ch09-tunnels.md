...
Подпрограмма копирования замечательно компактна. В реализации Introspec'а HL указывает на исходный байт в верхней левой четверти, а три адреса назначения (верхний правый, нижний левый, нижний правый) поддерживаются комбинацией абсолютных адресов и регистровой пары BC:
