...
![Вывод тестовой обвязки — красные полосы бордюра показывают такты (T-state), затраченные тестируемым кодом, чёрные промежутки показывают время простоя](../../build/screenshots/ch01_timing_harness.png)
