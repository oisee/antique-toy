...
![Прототип текстурированной сферы — таблицы пропусков кодируют сферическую проекцию, генерация кода во время выполнения формирует последовательности пикселей](../../build/screenshots/proto_ch06_sphere.png)
...
![Контур сферы, отрендеренный на ZX Spectrum — монохромная текстура наложена на вращающуюся сферу с помощью генерации кода по таблицам пропусков](../../build/screenshots/ch06_sphere.png)
